...
def run_nationwide_benchmark(sample_frac=0.50):
    ...
    # 2.4 Gradient Boosting (Scikit-Learn)
    try:
        from sklearn.ensemble import GradientBoostingClassifier
        gb_model = GradientBoostingClassifier(n_estimators=100, learning_rate=0.08, max_depth=5, random_state=42)
        gb_model.fit(X_tr_s, y_tr)
        predictions['Gradient Boosting'] = gb_model.predict_proba(X_te_s)[:, 1]
        ...
        logging.error(f"Gradient Boosting failed: {e}")
