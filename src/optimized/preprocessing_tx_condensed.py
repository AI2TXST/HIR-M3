...
def get_spark_session(app_name="OASIS_Preprocessing_TX_Condensed"):
...
def preprocess_notebook_pipeline_condensed(
    ...
    """
    Optimized and Condensed PySpark Preprocessing Pipeline for Texas OASIS Cohort Data.
    """
...
def main():
    ...
    output_file = "data/processed_final_mergedDF_TX_condensed.csv"
